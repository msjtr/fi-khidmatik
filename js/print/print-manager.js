...
function prepareData(order) {
    const cartRows = order.items.map(item => `
        <tr>
            ...
            <td style="padding: 10px 8px; border: 1px solid #e2e8f0; text-align: center;">${item.quantity || 0}</td>
