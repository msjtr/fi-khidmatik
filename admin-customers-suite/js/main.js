// 🌟 استيراد المكتبات والمسار بناءً على الكود المعتمد في نظامك 🌟
...
async function loadCustomerData() {
    ...
    try {
        ...
        if (docSnap.exists()) {
            ...
            console.error("العميل غير موجود في قاعدة البيانات!");
            alert("تنبيه: لا توجد بيانات لهذا العميل.");
        }
    } catch (e) { 
...
// 🌟 التصدير السحابي المباشر عبر Vercel 🌟
